...
Route::get('pdfcreate',[DocController::class,'create']);
...
//    Route::post('PA1_insert', [PA1Controller::class, 'PA1_insert']);
    ...
    Route::get('PA', [PA1Controller::class, 'PA1_1']);  
       
    Route::post('school',[MasterController::class,'get_school']);
    Route::post('department',[MasterController::class,'get_department']);
   ...
   //////////////////////////////////////////////////////////// 
    ...
    //////////////////////////////////////////////////////////////////////////
    Route::post('PA_1_school_set', [PA1Controller::class, 'PA_1_school_set']);
  ...
  ##########################################################################################
    ...
    Route::post('PA_3_agree_update_field', [PA3Controller::class, 'PA_3_agree_update_field']);
     Route::post('PA_3_agree', [PA3Controller::class, 'PA_3_agree']);
    ...
    Route::get('document/word', [PA5Controller::class, 'document_word']);
    Route::post('pdf', [PA5Controller::class, 'document_pdf']);
    Route::post('uploadfile', [PA5Controller::class, 'uploadfile']);
  ...
  // Route::get('superv/high', [SupervisorController::class, 'high_index']);
