...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
 ...
 <div class="containner">
    <div class="panel">
        <center><span class="topic">คำนำ</span></center>
<br><br>
<center>
 ...
 <br style="page-break-before: always">
  ...
  <div class="panel">
        ...
        <center><span class="topic">สารบัญ</span></center>
...
<br><b>ภาคผนวก</b>
  ...
  <br style="page-break-before: always">
      ...
      <div class="panel">
        <center><span class="topic">ข้อตกลงในการพัฒนางานสำหรับครู
                <br>(Performance Agreement)</span></center>
...
//    
//   $score=App\pa_standard::get_score_standard(uId(),PA_year(),$standards->no,$items->no,$items->owner);
//   $degree = degree($score);
//   
//   if($degree=="ดีมาก"){
//      $degree5+=1;   
...
?>       
        <span class="text_blue_small">
            <br>
           <table style="width:60%;font-size:10pt;" border="0">
                <tr>
            ...
            <table style="width:100%;font-size:10pt;" border="1">
                ...
                <tr class="tr_header">
                    ...
                    <th>{!!$sum_score=App\pa_standard::get_result_score_standard(uId(),PA_year(),'0',$standards->no,'owner')!!}</th>
                ...
                <td style="text-align:center;">
                 {!!$scores=App\pa_standard::get_score_standard(uId(),PA_year(),$standards->no,$items->no,$items->owner)!!}
     ...
     <div class="panel">
            ...
            <table style="width:100%" border="1">
                <tr style="height:70px;">
                 ...
                 @foreach($standard->where('no',">",1)->where('no',"<=",4) as $standards) 
                <tr class="tr_header">
                    <th>{{$standards->detail}}</th>
                    <th>{!!$sum_score=App\pa_standard::get_result_score_standard(uId(),PA_year(),'0',$standards->no,'owner')!!}</th>
                    <th>{{degree($sum_score)}}</th>
        ...
        <div class="panel">
          ...
          <div class="page_header">
             ...
             <br>
                ...
                <div class="col-md-9 col-lg-9 col-sm-12" style="border: 1px solid green;padding:0.5em;margin: 0 auto;">
                    ...
                    <table class="table_evaluation_doc"  border='0' style="color:#1050A2;">
                        ...
                        <tr style="height:50px;">
                            <th style="width:40%;padding:0;padding-left:20px;text-align:left;"><b>{{$topic0->detail}}</b></th>
                            <th style="width:20%;text-align:center;padding:0;">{!! App\pa_evaluation::find_avg_answer($topic0->no,uId(),PA_year(),$topic0->eva_id) !!}</th>
                        </tr>
                    ...
                    <div class="table-responsive">
                        ...
                        <tr class="tr_header_green" style="height:50px;">
                           ...
                           <th style="width:20%;">{!! App\pa_evaluation::find_avg_answer($topic1->no,uId(),PA_year(),$topic1->eva_id) !!}</th>
                           <th style="width:20%;"></th>
                        </tr>
                     
                        <?php $question = App\pa_evaluation::find_question($topic1->no); ?>
                        ...
                        <tr class="tr_header_tranparent" style="height:50px;text-align:left;">
                            ...
                            <td>{!! App\pa_evaluation::find_answer($question->root,$question->no,uId(),PA_year(),$question->eva_id) !!}</td>
                            <td>ไม่มีคะแนน</td>
                        </tr>
                       @endforeach
       ...
       <div class="panel">
                    ...
                    <div class="table-responsive">
                        ...
                        <tr style="text-align:center;height:70px;">
                         ...
                         @foreach($topic->where('root',0)->where('no','>',1)->where('no','<=',3) as $topic1)
                        <tr class="tr_header_green" style="height:50px;">
                           <th style="width:60%;padding-left:20px;">{{$topic1->detail}}</th>
                           <th style="width:20%;">{!! App\pa_evaluation::find_avg_answer($topic1->no,uId(),PA_year(),$topic1->eva_id) !!}</th>
                           <th style="width:20%;"></th>
             ...
             <div class="col-md-12 col-lg-12 col-sm-12" style="margin-top:30px;margin-bottom:50px;">
                    ...
                    <div class="table-responsive">
                        ...
                        <tr style="text-align:center;height:70px;">
                         ...
                         @foreach($topic->where('root',0)->where('no','>=',4)->where('no','<=',5) as $topic1)
                        <tr class="tr_header_green" style="height:50px;">
                           <th style="width:60%;padding-left:20px;">{{$topic1->detail}}</th>
                           <th style="width:20%;">{!! App\pa_evaluation::find_avg_answer($topic1->no,uId(),PA_year(),$topic1->eva_id) !!}</th>
                           <th style="width:20%;"></th>
        ...
        <br style="page-break-before: always">
         ...
         <div class="panel" style="font-size:10pt;">
