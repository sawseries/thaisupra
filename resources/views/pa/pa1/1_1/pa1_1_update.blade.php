...
<!--                                 <input type="text" value="{{$uProfile->prename}}" id="txtprename" name="txtprename" onchange="update_field('prename');">-->
                                 <?php $arrprenm = ["นาย","นาง","นางสาว","ด.ช.","ด.ญ.","อื่นๆ"]; ?>
                                <select id="txtprename" name="txtprename" class="form-control" onchange="update_field(this,'prename');">
                ...
                <table class="tbl_data" border="0">
                    <tr>
                        ...
                        <td>
                            ...
                            @if($uProfile->department_big==$department->department_nm)
